...
public class Example_back {
	...
	try {
	   ...
	   // System.out.println((Point)result.centroid);
	    FileWriter fstream  = new FileWriter("data2_1.txt");
	   ...
	   // for (int i=0; i<results.found; i++) {
	    FileWriter fstream1  = new FileWriter("type1_1.txt");
	    BufferedWriter out1 = new BufferedWriter(fstream1);
	    FileWriter fstream2  = new FileWriter("type2_1.txt");
	    BufferedWriter out2 = new BufferedWriter(fstream2);
	    FileWriter fstream3  = new FileWriter("type3_1.txt");
	    ...
	    FileWriter fstream_d  = new FileWriter("relation_d.txt");
