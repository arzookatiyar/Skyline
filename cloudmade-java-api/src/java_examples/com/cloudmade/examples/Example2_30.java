...
public class Example2_30 {
	...
	try {
		GeoResults results11 = client.find_range("cafe", new Point(51.51558,-0.141449), 30, 5000);
	    GeoResults results12 = client.find_range("pub", new Point(51.51558,-0.141449), 30, 5000);
	    GeoResults results13 = client.find_range("museum", new Point(51.51558,-0.141449), 30, 5000);
	    //result = results.results[1];
	   // System.out.println(result.properties);
	    //System.out.println("id "+result.id);
	   // System.out.println((Point)result.centroid);
	    FileWriter fstream  = new FileWriter("Sample_30/data2_30.txt");
	   ...
	   // for (int i=0; i<results.found; i++) {
	    FileWriter fstream1  = new FileWriter("Sample_30/type1_30.txt");
	    BufferedWriter out1 = new BufferedWriter(fstream1);
	    FileWriter fstream2  = new FileWriter("Sample_30/type2_30.txt");
	    BufferedWriter out2 = new BufferedWriter(fstream2);
	    FileWriter fstream3  = new FileWriter("Sample_30/type3_30.txt");
	    BufferedWriter out3 = new BufferedWriter(fstream3);
	    FileWriter fstream_node  = new FileWriter("Sample_30/relation_node_30.txt");
	    ...
	    for (int i=0; i<(results11.found+results12.found+results13.found); i++) {
	    	...
	    	for (int j=0; j<(results11.found+results12.found+results13.found); j++) {
	    		...
	    		//	System.out.println((results.results[i]).centroid+"  "+(results.results[j]).centroid);
	    			...
	    			GeoResults results3 = client.present_along_route("museum", route.geometry.points, 20, 30);
	    ...
	    FileWriter fstream_o  = new FileWriter("Sample_30/order_30.txt");
	    ...
	    FileWriter fstream_s  = new FileWriter("Sample_30/relation_s30.txt");
	    BufferedWriter out_s = new BufferedWriter(fstream_s);

	    FileWriter fstream_d  = new FileWriter("Sample_30/relation_d30.txt");
	    ...
	    if (temp_s == false) {
	    	...
	    	for (int j=0; j<(results11.found+results12.found+results13.found); j++) {
    			...
    			GeoResults results3 = client.present_along_route("museum", route_s.geometry.points, 20, 30);
	    ...
	    if (temp_d == false) {
	    	...
	    	for (int j=0; j<(results11.found+results12.found+results13.found); j++) {
    			...
    			GeoResults results3 = client.present_along_route("museum", route_d.geometry.points, 20, 30);
