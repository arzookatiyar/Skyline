...
public class Example2 {
	...
	try {
	   ...
	   // System.out.println((Point)result.centroid);
	    FileWriter fstream  = new FileWriter("data2_30.txt");
	   ...
	   // for (int i=0; i<results.found; i++) {
	    FileWriter fstream1  = new FileWriter("type1_30.txt");
	    BufferedWriter out1 = new BufferedWriter(fstream1);
	    FileWriter fstream2  = new FileWriter("type2_30.txt");
	    BufferedWriter out2 = new BufferedWriter(fstream2);
	    FileWriter fstream3  = new FileWriter("type3_30.txt");
	    BufferedWriter out3 = new BufferedWriter(fstream3);
	    FileWriter fstream_node  = new FileWriter("relation_node.txt");
	    ...
	    FileWriter fstream_s  = new FileWriter("relation_s30.txt");
	    BufferedWriter out_s = new BufferedWriter(fstream_s);

	    FileWriter fstream_d  = new FileWriter("relation_d30.txt");
	    ...
	    if (temp_d == false) {
	    	...
	    	//meaning that the id is already present in the graph formed
    		out_d.write(Integer.toString(source_id));	
    	}
