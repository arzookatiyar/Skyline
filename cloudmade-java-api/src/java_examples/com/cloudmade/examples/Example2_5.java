...
public class Example2_5 {
	...
	try {
		GeoResults results11 = client.find_range("cafe", new Point(51.51558,-0.141449), 5, 5000);
	    GeoResults results12 = client.find_range("pub", new Point(51.51558,-0.141449), 5, 5000);
	    GeoResults results13 = client.find_range("hotel", new Point(51.51558,-0.141449), 5, 5000);
	    //result = results.results[1];
	   // System.out.println(result.properties);
	    //System.out.println("id "+result.id);
	   // System.out.println((Point)result.centroid);
	    FileWriter fstream  = new FileWriter("Sample_5/data2_5.txt");
	   ...
	   // for (int i=0; i<results.found; i++) {
	    FileWriter fstream1  = new FileWriter("Sample_5/type1_5.txt");
	    BufferedWriter out1 = new BufferedWriter(fstream1);
	    FileWriter fstream2  = new FileWriter("Sample_5/type2_5.txt");
	    BufferedWriter out2 = new BufferedWriter(fstream2);
	    FileWriter fstream3  = new FileWriter("Sample_5/type3_5.txt");
	    BufferedWriter out3 = new BufferedWriter(fstream3);
	    FileWriter fstream_node  = new FileWriter("Sample_5/relation_node_5.txt");
	    ...
	    FileWriter fstream_o  = new FileWriter("Sample_5/order_5.txt");
	    ...
	    FileWriter fstream_s  = new FileWriter("Sample_5/relation_s5.txt");
	    BufferedWriter out_s = new BufferedWriter(fstream_s);

	    FileWriter fstream_d  = new FileWriter("Sample_5/relation_d5.txt");
