...
public class CMClientTest extends TestCase {
	//BC9A493B41014CAABB98F0471D759707
//	private CMClient client = new CMClient("BC9A493B41014CAABB98F0471D759707", "qa01.cm.kyiv.cogniance.com", 80);
	...
	public void testGetTileGeoCoord() throws Exception {
		...
		FileOutputStream fos = new FileOutputStream("tileGC.png");
		fos.write(tile);
		fos.close();
		try {
	...
	public void testGetTileTileCoord() throws Exception {
		// Getting tile for London area
		byte[] tile = client.getTile(256, 170, 9, 1, 256);
		assertNotNull("Tile is null", tile);
		assertTrue("Tile is too small", tile.length > 1000);
		FileOutputStream fos = new FileOutputStream("tileTC.png");
		fos.write(tile);
		fos.close();
		try {
			client.getTile(151, 14000, 9, 1, 256);
			fail("HTTPError must be raised");
		} catch (HTTPError e) {
