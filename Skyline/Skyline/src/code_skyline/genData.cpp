...
// *************************************************************************** 
	...
	{ 
	if (argc != 5) { 
	printf("generate - Generierung von Testdaten für Skyline\n\n"); 
	printf("Syntax: generate <Dimensionen> <Type> <Num Points> <File Output>\n"); 
	printf(" mit Type = E(qually) | C(orrelated) | A(nti-correlated)\n\n"); 
	} else { 
