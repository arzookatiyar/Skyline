		...
		for (int i=0; i<2; i++) {
		    ...
		    for (int j=13; j<15; j++) {
				if (i!=j) {
				    ...
				    int number_results1 = Aggregated_Skyline.find_aggregatedskyline();				    
				    long end_time1 = System.nanoTime();
				    long start_time2 = System.nanoTime(); 
				    int number_results2 = Normal_Skyline.find_normalskyline();				    
				    ...
				    bw11.write("\t");
				    bw11.write(String.valueOf(number_results1));
				    bw11.write("\t");
				    bw11.write(String.valueOf(end_time1-start_time1));
				    bw11.write("\t");
				    bw11.write(String.valueOf(number_results2));
				    bw11.write("\t");
